...
#create paddles
player2_paddle = Paddle(screen_width - 40, screen_height//2) #direita
cpu_paddle = Paddle(screen_width - 40, screen_height//2)
player_paddle = Paddle(20, screen_height//2) #esquerda
...
while run:
    ...
    if started == True:
        ...
        draw_text('selecione o modo:', font, white, 150, 200)
        draw_text('1 - P1 x CPU', font, white, 150, 250)
        draw_text('2 - P1 x P2', font, white, 150, 285)
    ...
    if mode == 1:
        ...
        draw_text('CPU ' + str(cpu_score), font, white, screen_width - 100, 15)
